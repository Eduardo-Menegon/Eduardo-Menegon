...
💻 Desenvolvedor Back-end em formação | Java & Spring
 Focado em lógica de programação e construção de APIs

* Desenvolvendo projetos em **Java** e **C**
*  Estudando **Spring Boot** para APIs REST
* Praticando lógica de programação diariamente
